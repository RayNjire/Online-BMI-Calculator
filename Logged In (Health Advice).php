...
<html>
    <head>
        <title>BMI Calculator - Health Advice(Logged In)</title>
...
<br>
                <div class = "main-elements">
                    <ul align="center" class="main-nav">
                        ...
                        <li class = "active"><div><a href="Logged In (Health Advice).php">HEALTH ADVICE</a></div></li>
                    </ul>
                </div>
            </div>
<br><br>            
            <div class = "paragraphs">
                <div class = "Diet">
                    <h3>Follow a Heart-Healthy Diet</h3> <h4 class = "Logout" align = "right">Logged In as <?php echo "".$_SESSION['TheUsersName']."";?>. <a class = "LogoutLink" href = "Health Advice.php">Logout</a></h4><br><br>
